...
import { CVButtom } from "./hero/CVButtom";
    ...
    <section className={`relative w-full h-screen mx-auto overflow-x-hidden`}>
      ...
      >
        ...
        <motion.div
          ...
          style={{ opacity }}
          className="absolute xs:bottom-10 sm:bottom-5 inset-x-auto left-0 right-0 mx-auto bottom-6 w-1/2 flex justify-center items-center"
        >
          <a href="#about">
            <div
              className="w-[32px] h-[55px] rounded-3xl border-4 border-secondary flex justify-center
            items-start p-2"
            >
              <motion.div
                animate={{
